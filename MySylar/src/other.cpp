 ...
 * @Version: 1.0
 * @Author: LOSER
 * @Date: 2024-01-31 16:11:33
 * @LastEditors: LOSER
 * @LastEditTime: 2024-02-18 02:33:30
 */
#include "other.hpp"
#include "log.hpp"
namespace MySylar {

static Logger::loggerPtr otherLogger = LOG_NAME("system");
...
void Backtrace(std::vector<std::string> &bt, int size, int skip) {
    ...
    if (strings == NULL) {
        ERROR_LOG(otherLogger) << "backtrace_synbols error";
        return;
    }
